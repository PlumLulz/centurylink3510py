...
def centurylink3510(serial):
	...
	s2 = "%s%s%s%s%s%s%s%s%s%s%s%s%s" % (p[6:32], p[3], s1[0], s1[5], p[0], p[4], s1[3], s1[2], p[5], p[2], p[1], s1[1], s1[4])
...
parser = argparse.ArgumentParser(description='Centurylink keygen (Zyxel C3510ZX)')
parser.add_argument('serial', help='Serial Number')
args = parser.parse_args()

centurylink3510(args.serial)
